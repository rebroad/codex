...
package_linux() {
  ...
  write_package_json "$package_dir" "@rebroad/codex-cli-hybrid-linux-x64" linux x64
...
package_android() {
  ...
  write_package_json "$package_dir" "@rebroad/codex-cli-hybrid-android-arm64" android arm64
  mkdir -p "$package_dir/bin"
