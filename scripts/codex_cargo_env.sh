...
# Explicitly allow controlled benchmarks of compiler modes that sccache rejects,
# such as Cargo incremental compilation. Normal builds continue to use sccache.
if [[ "${CODEX_CARGO_DISABLE_SCCACHE:-0}" == "1" ]]; then
  SCCACHE_BIN=""
else
