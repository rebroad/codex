...
codex_build_setup := "commit_short=\"$(git rev-parse --short=10 HEAD)\"; CODEX_BUILD_TIMESTAMP=\"${commit_short}-000000000000\"; export CODEX_BUILD_TIMESTAMP;"
