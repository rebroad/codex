...
- Prefer end-to-end verification with `./scripts/build_codex.sh` from the designated build tree over localized checks when validating final build/run readiness. Ideally run it sending stdout and stderr to a file.
