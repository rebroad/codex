...
The TypeScript SDK wraps the `codex` CLI from `@reb.ai/codex`. It spawns the CLI and exchanges JSONL events over stdin/stdout.

## Installation

```bash
npm install @reb.ai/codex-sdk
```
...
```typescript
import { Codex } from "@reb.ai/codex-sdk";
