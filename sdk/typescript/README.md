...
The TypeScript SDK wraps the `codex` CLI from `@rebroad/codex`. It spawns the CLI and exchanges JSONL events over stdin/stdout.

## Installation

```bash
npm install @rebroad/codex-sdk
```
...
```typescript
import { Codex } from "@rebroad/codex-sdk";
