...
pub struct PromptDebugHttpToml {
    ...
    pub enabled: Option<bool>,
    /// Capture query input payloads as NDJSON payloads.
    pub capture_input: Option<bool>,
    /// Capture model output stream payloads as NDJSON payloads.
    pub capture_output: Option<bool>,
    /// Capture model reasoning-related stream payloads as NDJSON payloads.
