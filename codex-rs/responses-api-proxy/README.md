...
- We leverage [`codex_process_hardening`](https://github.com/rebroad/codex/blob/main/codex-rs/process-hardening/README.md) so `codex-responses-api-proxy` is run with standard process-hardening techniques.
