...
impl App {
    pub(super) async fn apply_permission_shortcut(
        ...
        if matches!(persistence, PermissionChangePersistence::SessionOnly) {
        ...
        let result: Result<()> = async {
            ...
            self.runtime_approval_policy_override =
                selection.approval_policy.map(RuntimeApprovalPolicyOverride::Explicit);
