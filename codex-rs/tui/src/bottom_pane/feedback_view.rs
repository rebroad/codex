...
const BASE_CLI_BUG_ISSUE_URL: &str =
    "https://github.com/rebroad/codex/issues/new?template=3-cli.yml";
...
mod tests {
    ...
    fn issue_url_available_for_bug_bad_result_safety_check_and_other() {
        ...
        let expected_external_url = "https://github.com/rebroad/codex/issues/new?template=3-cli.yml&steps=Uploaded%20thread:%20t";
